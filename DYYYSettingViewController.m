...
- (void)setupSettingItems {
    self.settingSections = @[
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"隐藏历史搜索" key:@"DYYYHideInteractionSearch" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"隐藏评论短剧" key:@"DYYYHideCommentViews" type:DYYYSettingItemTypeSwitch],
